...
<header>
    <nav class="haut-nav">
        ...
        <li class="haut-nom-utilisateur"><a href='index.php?action=profile'><img src="img\utilisateur.png" alt="utilisateur"><span>Nom d'utilisateur <!--<?php echo e($_SESSION['login']); ?>--> </span> </a></li>
